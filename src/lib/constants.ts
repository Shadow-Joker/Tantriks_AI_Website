...
export const INDUSTRY_MODULES: EcosystemModule[] = [
  ...
  },
  {
    ...
    title: 'Agriculture',
    category: 'Industry',
    description: 'AI agricultural helplines, crop diagnostic guidance, and localized advisory services designed for farmers.',
    latency: 'Multi-lingual',
    status: 'operational',
    icon: 'Globe',
    stats: 'Farmers Helpline',
  },
  {
    id: 'ecommerce',
    title: 'E-commerce',
    category: 'Industry',
    description: 'Intelligent shopping assistants that guide customers, answer inquiries, and streamline product discovery.',
    latency: 'Interactive',
    status: 'optimized',
    icon: 'Cpu',
    stats: 'AI Assistants',
