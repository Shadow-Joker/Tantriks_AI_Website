...
export function AccessDeniedPage() {
  ...
  return (
    <div className="pt-32 pb-24 md:pt-40 md:pb-36 bg-[#FFF3D5] text-[#2B3E2C] min-h-screen flex flex-col justify-center relative overflow-hidden">
      {/* Ambient Visual Shield */}
      <div className="absolute inset-0 bg-grid-pattern opacity-20 pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[350px] bg-[#4D694E]/10 blur-[130px] pointer-events-none rounded-full" />
