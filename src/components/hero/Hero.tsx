...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="min-h-[calc(100dvh-5rem)] flex flex-col justify-center items-center max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-12 md:pt-16 pb-12 z-20">
        {/* 2. Headline */}
        <motion.h1
